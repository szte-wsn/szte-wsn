 ...
 *
 *
 *  For examples, see the demo benchmarks below.
 *  These benchmarks are only for demo and reference purposes, so do not hesitate to erase them / comment them out to reduce memory overhead.
 */
 ...
 *  - if motecount is set to 5 (-mc 5): 50 reception (Mote 2,3,4,5 are present, hearing Mote 1),
 *  - ...
 */
_BMARK_START_
