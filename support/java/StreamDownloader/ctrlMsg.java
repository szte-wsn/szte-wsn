...
public class ctrlMsg extends net.tinyos.message.Message {
    ...
    public ctrlMsg(byte am_type) {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(am_type);
    }

    /** Create a new ctrlMsg of the given data_length. */
    public ctrlMsg(int data_length, byte am_type) {
        super(data_length);
        amTypeSet(am_type);
    }
     ...
     * and base offset.
     */
    public ctrlMsg(int data_length, int base_offset, byte am_type) {
     ...
     * as backing store.
     */
    public ctrlMsg(byte[] data, byte am_type) {
        super(data);
        amTypeSet(am_type);
    }
     ...
     */
    public ctrlMsg(byte[] data, int base_offset, byte am_type) {
     ...
     */
    public ctrlMsg(byte[] data, int base_offset, int data_length, byte am_type) {
     ...
     */
    public ctrlMsg(net.tinyos.message.Message msg, int base_offset, byte am_type) {
     ...
     */
    public ctrlMsg(net.tinyos.message.Message msg, int base_offset, int data_length, byte am_type) {
