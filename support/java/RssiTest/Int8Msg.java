 ...
 * This class implements a Java interface to the 'Int8Msg'
 * message type.
 */

public class Int8Msg extends net.tinyos.message.Message {
    ...
    /** Create a new Int8Msg of size 17. */
    public Int8Msg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Int8Msg of the given data_length. */
    ...
    /**
     * Create a new Int8Msg with the given data_length
     * and base offset.
     */
    ...
    /**
     * Create a new Int8Msg using the given byte array
     * as backing store.
     */
    ...
    /**
     * Create a new Int8Msg embedded in the given message
     * at the given base offset.
     */
    public Int8Msg(net.tinyos.message.Message msg, int base_offset) {
    ...
    /**
     * Return whether the field 'senderNodeID' is signed (true).
     */
    ...
    /**
     * Return whether the field 'receiverNodeID' is signed (true).
     */
    ...
    /**
     * Return whether the field 'sampleCnt' is signed (true).
     */
    ...
    /**
     * Return whether the field 'min' is signed (true).
     */
    ...
    /**
     * Return the value (as a byte) of the field 'min'
     */
    public byte get_min() {
    ...
    /**
     * Return whether the field 'max' is signed (true).
     */
    ...
    /**
     * Return the value (as a byte) of the field 'max'
     */
    public byte get_max() {
    ...
    /**
     * Return whether the field 'sum_a' is signed (true).
     */
    ...
    /**
     * Return the value (as a int) of the field 'sum_a'
     */
    ...
    /**
     * Return whether the field 'sum_e' is signed (true).
     */
    ...
    /**
     * Return the value (as a int) of the field 'sum_e'
     */
     ...
     */
    public void set_sum_e(int value) {
        setSIntBEElement(offsetBits_sum_e(), 32, value);
    }
