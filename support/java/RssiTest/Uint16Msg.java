 ...
 * This class implements a Java interface to the 'Uint16Msg'
 * message type.
 */

public class Uint16Msg extends net.tinyos.message.Message {
    ...
    /** Create a new Uint16Msg of size 19. */
    public Uint16Msg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Uint16Msg of the given data_length. */
    public Uint16Msg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Uint16Msg with the given data_length
     * and base offset.
     */
    public Uint16Msg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Uint16Msg using the given byte array
     * as backing store.
     */
    public Uint16Msg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public Uint16Msg(byte[] data, int base_offset) {
     ...
     */
    public Uint16Msg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Uint16Msg embedded in the given message
     * at the given base offset.
     */
    public Uint16Msg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public Uint16Msg(net.tinyos.message.Message msg, int base_offset, int data_length) {
