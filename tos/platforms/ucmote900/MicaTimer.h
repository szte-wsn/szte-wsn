// $Id: MicaTimer.h,v 1.3 2009/10/28 15:02:33 phsommer Exp $
/*
...
/* This file defines the rates at which the mica family's atmega128 timer 1
   ...
   based on the value of the PLATFORM_MHZ preprocessor symbol, which shoud approximate
   the platform's PLATFORM_MHZ rate.
...
#else
#error "Unknown clock rate. PLATFORM_MHZ must be defined to one of 1, 2, 4, or 8."
#endif

enum {
  PLATFORM_PLATFORM_MHZ = PLATFORM_MHZ
};
