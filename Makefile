...
BUILD_EXTRA_DEPS = ctrlmsg_t.py setup_t.py StatT.java CtrlMsgT.java SetupT.java
CLEAN_EXTRA = ctrlmsg_t.py setup_t.py StatT.java CtrlMsgT.java SetupT.java main.elf
